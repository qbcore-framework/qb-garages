Locales['it'] = {
    ...
    ["DepotVehicles"] = "Deposito veicoli",
    ["Back"] = "Indietro",
    ...
    ["client_main_function_DepotList_notify_1"] = "Non ci sono veicoli nel sequestrati",
    ...
    ["ParkVehicle"] = "~g~E~w~ - Parcheggio",

    ["client_main_CreateThread_notify1"] = "Veicolo parcheggiato, %s",
    ["client_main_CreateThread_notify2"] = "Nessuno possiede questo veicolo",
}