...
WarpIntoVehicle = false -- True == If you spawn a vehicle, you will be teleported into it
UsingQbMechanic = true -- True == Save and Set vehicle status on store / spawn such as: engine, body, radiator, axle, brakes, clutch, fuel
...
Garages = {
    ...
    ["pillboxgarage"] = {
        ...
        spawnPoints = {
            vector4(220.93, -806.61, 30.61, 249.0),
            vector4(224.0, -799.23, 30.61, 249.0),
            vector4(227.07, -791.93, 30.61, 249.0),
        },
    ...
    --    spawnPoints = {
    --         vector4(491.0, -1314.69, 29.25, 304.5), 
    --    },
    --    showBlip = true,
    ...
    ["impoundlot"] = {
        ...
        spawnPoints = {
            vector4(407.92, -1646.29, 29.29, 226.39),
        },
        showBlip = true,
